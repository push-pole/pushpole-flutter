...
class PushPole {
  ...
  static Future<void> setNotificationOn() async =>
      _channel.invokeMethod("PushPole#setNotificationOn");

  static Future<bool> isNotificationOn() async =>
      _channel.invokeMethod("PushPole#isNotificationOn");

  /// Check if PushPole is registered to server or not. This method is not completely reliable.
  static Future<bool> isPushPoleInitialized() async =>
      await _channel.invokeMethod("PushPole#isPushPoleInitialized");
